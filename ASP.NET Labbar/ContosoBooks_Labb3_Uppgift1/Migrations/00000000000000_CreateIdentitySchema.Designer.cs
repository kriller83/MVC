...
using ContosoBooks_Labb3_Uppgift1.Models;

namespace ContosoBooks_Labb3_Uppgift1.Migrations
{
    ...
    partial class CreateIdentitySchema
    {
        ...
        public override void BuildTargetModel(ModelBuilder builder)
        {
            ...
            builder.Entity("ContosoBooks_Labb3_Uppgift1.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .GenerateValueOnAdd()
                        .Annotation("OriginalValueIndex", 0);
            ...
            builder.Entity("Microsoft.AspNet.Identity.EntityFramework.IdentityUserClaim<string>", b =>
                {
                    b.Reference("ContosoBooks_Labb3_Uppgift1.Models.ApplicationUser")
                        .InverseCollection()
                        .ForeignKey("UserId");
                });
