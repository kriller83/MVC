...
using ContosoBooks_Labb3_Uppgift1_Ny.Models;

namespace ContosoBooks_Labb3_Uppgift1_Ny.Migrations
{
    ...
    partial class ApplicationDbContextModelSnapshot : ModelSnapshot
    {
        public override void BuildModel(ModelBuilder builder)
        {
            ...
            builder.Entity("ContosoBooks_Labb3_Uppgift1_Ny.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .GenerateValueOnAdd()
                        .Annotation("OriginalValueIndex", 0);
            ...
            builder.Entity("Microsoft.AspNet.Identity.EntityFramework.IdentityUserClaim<string>", b =>
                {
                    b.Reference("ContosoBooks_Labb3_Uppgift1_Ny.Models.ApplicationUser")
                        .InverseCollection()
                        .ForeignKey("UserId");
                });
